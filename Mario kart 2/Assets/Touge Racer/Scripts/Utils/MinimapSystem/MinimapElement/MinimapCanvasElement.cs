...
{
    [AddComponentMenu("Minimap/Minimap Element/Minimap Canvas Element")]
    [ExecuteInEditMode]
    public class MinimapCanvasElement : MonoBehaviour
    {
        // List of all canvas elements: This list serves as a central registry to store instances of MinimapCanvasElement.
        // It keeps track of all canvas elements available in the application.
        public static List<MinimapCanvasElement> listOfCanvasElements = new List<MinimapCanvasElement>();

        // worldElement: This field stores a reference to a MinimapWorldElement associated with this canvas element.
        // It allows this canvas element to track its corresponding world element.
        [SerializeField] MinimapWorldElement worldElement;
        ...
        // Constructor: This constructor is called when a new instance of MinimapCanvasElement is created.
        ...
        // TryAssociateCanvasElement: This function attempts to associate a canvas element with a specific MinimapWorldElement.
        ...
        public static bool TryAssociateCanvasElement(MinimapWorldElement worldElement)
        {
            foreach (MinimapCanvasElement instance in listOfCanvasElements)
            {
        ...
        // SetWorldElement: This function is responsible for associating a MinimapWorldElement with this canvas element.
        ...
        public void SetWorldElement(MinimapWorldElement worldElement)
        {
