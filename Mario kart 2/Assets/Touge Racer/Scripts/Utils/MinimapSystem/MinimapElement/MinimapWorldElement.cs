...
{
    [AddComponentMenu("Minimap/Minimap Element/Minimap World Element")]
    [ExecuteInEditMode]
    public class MinimapWorldElement : MonoBehaviour
    {
        ...
        public void UpdateElementTransformOnMinimap()
        {
            ...
            minimapCanvasTransform.localPosition = newPosition;
            minimapCanvasTransform.localRotation = newRotation;
        }
        ...
        private Vector3 CalculatePositionOnMinimap()
        {
            ...
            float transformXPosOnMinimap = minimapManager.MinimapBounds.MaxX - (transformXPosInWorldRatioToMinimap * minimapManager.MinimapBounds.XTotalSize);
            float transformYPosOnMinimap = minimapManager.MinimapBounds.MaxY - (transformZPosInWorldRatioToMinimap * minimapManager.MinimapBounds.YTotalSize);
        ...
        public void SetMinimapManager()
        {
            ...
            minimapManager = FindAnyObjectByType<MinimapManager>(); // Find the minimap manager in the scene.
        }
        ...
        public void SetCanvasTransformParent()
        {
            ...
            minimapCanvasTransform.SetParent(minimapManager.ParentTransformLayers[(int)renderOrder]);
        }
        ...
        private void CreateMinimapCanvasTransform()
        {
            ...
            if (MinimapCanvasElement.TryAssociateCanvasElement(this))
            {
                return;
            }
            ...
            MinimapCanvasElement canvasElement = minimapCanvasTransform.gameObject.AddComponent<MinimapCanvasElement>();
